...
public class RequestParameterExtractor {
  ...
  public static Map<String, Object> prepareForJson(Map<String, List<String>> parameters) {
  ...
  public static Map<String, List<String>> extractFromGetRequest(String queryString)
  ...
  public static Map<String, List<String>> extractFromPostRequest(HttpServletRequest req) {
    Map<String, List<String>> parameters = new HashMap<>();
